        ...
        return (
            <View>
                ...
                {/* <View style={{ flexDirection: "row", alignContent: "center", justifyContent: 'center' }}>
                    ...
                    <View>
                        <Text style={{ alignSelf: "center", color: "#000", fontFamily: "Poppins-Regular", fontSize: 20, textAlign: "center" }}>
                            Code Expires in
                    </Text>
                    </View>
                ...
                {!this.state.loader ? <View style={{ alignContent: "center", alignItems: "center", marginTop: "5%" }}>
                    {/* <LinearGradient colors={['#fff', '#fc8b8c', '#fc8b8c']} style={{ width: "90%", borderRadius: 10 }}>
                        <Button onPress={this.codeChecker} style={{ justifyContent: "center", alignContent: "center", alignItems: "center", backgroundColor: "none", borderRadius: 10, opacity: 0.7 }}>
                            <Text style={{ alignSelf: "center", color: "#fff", fontFamily: "Poppins-Regular", : 20 }}>
                                Continue
                    </Text>
                        </Button>
                    </LinearGradient> */}
