                        ...
                        text: 'Yes', onPress: () => {
                            ...
                            fetch("http://hnh1.xyz/soplush_new/soplush/cart/cart.php?action=change_cart_service_status", {
                                ...
                                .then(resp => {
                                    ...
                                    if (successData.status === true) {
                                        // console.log("successData.data[0].role_id === 3", successData.data[0].role_id === 3)
                                        console.log(" successData.data CHANGE STATUS", successData)
                                        // this.state.services.splice(index, 1)
                                        this.state.data.splice(index, 1)
                                        console.log('length index', index)
                    ...
                    <Header
                        ...
                        centerComponent={
                            <View style={{ alignContent: "center", alignItems: "center", alignSelf: "center" }}>
                                {!this.state.focusOn ? <Text style={{ alignSelf: 'center', fontSize: 20, fontFamily: "Poppins-Regular" }}>BOOKING REQUEST</Text>
                                    :
                                        ...
                                        return (
                                            <View key={index} style={{ width: '90%', padding: 10, alignSelf: 'center', right: 10 }}>
                                                <View style={{ display: "flex", flexDirection: "row", width: "100%" }}>
                                                    ...
                                                    <Text style={{ marginLeft: "3%", fontFamily: "Poppins-Regular", fontSize: 15, width: '30%' }}>{value.username}</Text>
                                                    ...
                                                    >
                                                        <Text style={{ color: "#fc8b8c", borderBottomColor: "#ff8385", borderBottomWidth: 1, fontFamily: "Poppins-Regular", textAlign: "right", fontSize: 13, alignSelf: 'flex-end', justifyContent: 'flex-end' }}>VIEW DETAILS</Text>
                                                    </TouchableOpacity>
                                                </View>
                                                ...
                                                <View style={{ display: "flex", flexDirection: "row" }}>
                                                    ...
                                                    <Text style={{ marginLeft: "3%", fontFamily: "Poppins-Regular", fontSize: 15 }}>{newdate}</Text>
                                                </View>
