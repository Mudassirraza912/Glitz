...
//                       {!this.state.focusOn  ? <Text style={{ alignSelf: "center", fontSize: 30, fontFamily: "Poppins-Regular" }}>VIEW BOOKING</Text> 
//                       :
...
//                                     <Text style={{width:"50%", fontFamily:"Poppins-Regular", fontSize: 20}}>Name</Text>
//                                     <Text style={{marginLeft:"3%", fontFamily:"Poppins-Regular", fontSize: 20}}>{value.username}</Text>
                                   
//                                 </View>

//                                 <View style={{display:"flex", flexDirection:"row"}}> 
//                                     <Text style={{width:"50%", fontFamily:"Poppins-Regular", fontSize: 20}}>Service</Text>
//                                     <Text style={{marginLeft:"3%", fontFamily:"Poppins-Regular", fontSize: 20}}>{value.services[0].service_name}</Text>
//                                 </View>

//                                 <View style={{display:"flex", flexDirection:"row"}}> 
//                                     <Text style={{width:"50%", fontFamily:"Poppins-Regular", fontSize: 20}}>Time</Text>
//                                     <Text style={{marginLeft:"3%", fontFamily:"Poppins-Regular", fontSize: 20}}>{value.time_slot}</Text>
//                                 </View>

//                                  <View style={{display:"flex", flexDirection:"row"}}> 
//                                     <Text style={{width:"50%", fontFamily:"Poppins-Regular", fontSize: 20}}>Date</Text>
//                                     <Text style={{marginLeft:"3%", fontFamily:"Poppins-Regular", fontSize: 20}}>{value.service_date}</Text>
//                                 </View>
            ...
            <View style={{ flex: 1, height:'100%', width:'100%', marginTop: -80 }}>
                <ImageBackground source={require('../../../assets/inner.png')} style={{ height: "100%", width: "100%", opacity: 0.9 }}>
                    ...
                    <Header
                        ...
                        centerComponent={
                            <View style={{alignContent:"center", alignItems:"center", alignSelf:"center"}}>
                      {!this.state.focusOn  ? <Text style={{alignSelf:'center',fontSize: 20, fontFamily: "Poppins-Regular" }}>VIEW BOOKING</Text> 
                      :
                             ...
                             {this.state.data.length > 0 ?   <View style={{ backgroundColor: '#800', borderRadius: 10, width: "95%" }}>
                                    {this.state.data.map((value, index) => {
                                        return (
                                            <View key={index} style={{width:'90%', padding: 10, alignSelf:'center'}}>
                                                <View style={{ display: "flex", flexDirection: "row" }}>
                                                    <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize:17, color:'#aaaaaa' }}>Name</Text>
                                                    <Text style={{ marginLeft: "3%", fontFamily: "Poppins-Regular" , fontSize:15}}>{value.username}</Text>
                                                    {/* <TouchableOpacity onPress={() => {
                                                        this.props.navigation.navigate('BookingDetail', {
                                                            bookinDetail: value,
                                                        })
                                                    }}>
                                                        <Text style={{ marginLeft: "30%", color: "#fc8b8c", borderBottomColor: "#fc8b8c", borderBottomWidth: 1, fontFamily: "Poppins-Regular", width: '40%', textAlign: "center", fontSize:15 }}>VIEW DETAILS</Text>
                                                    </TouchableOpacity> */}
                                                </View>

                                                <View style={{ display: "flex", flexDirection: "row" }}>
                                                    <Text style={{ width: "30%", fontFamily: "Poppins-Regular" , fontSize:17, color:'#aaaaaa'}}>Service</Text>
                                                    <Text style={{ marginLeft: "3%", fontFamily: "Poppins-Regular" , fontSize:15}}>{value.service_name}</Text>
                                                </View>

                                                <View style={{ display: "flex", flexDirection: "row" }}>
                                                    <Text style={{ width: "30%", fontFamily: "Poppins-Regular" , fontSize:17, color:'#aaaaaa'}}>Time</Text>
                                                    <Text style={{ marginLeft: "3%", fontFamily: "Poppins-Regular", fontSize:15 }}>{value.time_slot}</Text>
                                                </View>

                                                <View style={{ display: "flex", flexDirection: "row" }}>
                                                    <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize:17 , color:'#aaaaaa'}}>Date</Text>
                                                    <Text style={{ marginLeft: "3%", fontFamily: "Poppins-Regular", fontSize:15 }}>{value.service_date}</Text>
                                                </View>
