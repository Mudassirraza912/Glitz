                                ...
                                {this.state.selectedUser !== null ?
                                    ...
                                    <View style={{ backgroundColor: '#800', borderRadius: 20, width: "90%", padding: 0 }}>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15, marginLeft: 10, padding: 5 }}>
                                            <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>Name</Text>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15, marginLeft: 10, padding: 5 }}>
                                            <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>Email</Text>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15, marginLeft: 10, padding: 5}}>
                                            <Text  style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>Gender</Text>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15, marginLeft: 10 , padding: 5}}>
                                            <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>Select Date</Text>
                                    ...
                                    {this.state.profileData.birthdate}</Text> */}
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15, marginLeft: 10, padding: 5}}>
                                            <Text style={{ width: "50%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>Available Slot</Text>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15, marginLeft: 10, padding: 5 }}>
                                            <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>Expertise</Text>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15, marginLeft: 10, padding: 5 }}>
                                            <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>About me</Text>
                                        ...
                                        <View style={{ flex: 1,  alignItems: 'center', marginTop: 15, padding: 3, width:'100%'  }}>
                                            <Text style={{ width: "30%", marginLeft: 15, fontFamily: "Poppins-Regular", fontSize: 15, color: "gray", alignSelf: "flex-start" }}>
                                                Work</Text>
                                            <FlatList style={{ flex: 1, marginTop: "3%" }}
                                        ...
                                        <View>
                                            ...
                                            <View style={{ alignContent: "center", alignItems: "center", marginTop: "5%" }}>
                                                <Button onPress={() => {
                                                    ...
                                                    <Text style={{ alignSelf: "center", color: "#fff", fontFamily: "Poppins-Regular", fontSize: 15 }}>
                                                        Book Now
</Text>
                                                </Button>
                                            </View>
                                        ...
                                        <View style={{ alignContent: "center", alignItems: "center", marginTop: -10, paddingVertical:30 }}>
                                            <LinearGradient start={{ x: 0.05, y: 0.0 }} end={{ x: 1.0, y:0.0 }} colors={['#000', '#9d7e2c', '#e2bf6b']} style={{ width: "90%", borderRadius: 10 }}>
                                                <TouchableOpacity onPress={() => {
                                                    ...
                                                    <Text style={{ alignSelf: "center", textAlignVertical: "center", color: "#fff", fontFamily: "Poppins-Regular", paddingVertical: '6%', fontWeight:'bold'}}>
                                                        BOOK NOW
                    </Text>
                                                </TouchableOpacity>
                                            </LinearGradient>
                                    ...
                                    <Card containerStyle={{ backgroundColor: '#800', borderRadius: 10, width: "90%", }}>
                                        ...
                                        <View style={{ display: "flex", flexDirection: "column", marginTop: 15 }}>
                                            <Text style={{ width: "30%", fontFamily: "Poppins-Regular", fontSize: 15, color: "gray" }}>Selected Date</Text>
                                            <DatePicker
                                                // date={this.state.date} //initial date from state
                                        ...
                                        <View style={{alignContent: "center", alignItems: "center", marginTop: "15%" }}>
                                            <LinearGradient start={{ x: 0.05, y: 0.0 }} end={{ x: 1.0, y:0.0 }} colors={['#000', '#9d7e2c', '#e2bf6b']} style={{ width: "90%", borderRadius: 10 }}>
                                                <TouchableOpacity onPress={() => {
                                                    ...
                                                    <Text style={{ alignSelf: "center", textAlignVertical: "center", color: "#fff", fontFamily: "Poppins-Regular", fontSize: 15, paddingVertical: 15 , fontWeight:'bold'}}>
                                                        Book Now
                    </Text>
                                                </TouchableOpacity>
                                            </LinearGradient>
