...
//                              <Avatar  editButton={{name:"camera",type:"font-awesome", size:25, iconStyle:{marginTop:10} ,containerStyle:{backgroundColor:"#fc8b8c", borderRadius:50, height: 45, width: 45, borderColor:'#fff' , borderWidth:2 ,marginRight:60}, color:"#fff", underlayColor:"#fc8b8c", reverseColor:"#fc8b8c", }}  onPress={this.openGallery} onEditPress={this.openGallery} containerStyle={{backgroundColor:"#fc8b8c",}} showEditButton  rounded size="xlarge" source={{uri:`http://hnh1.xyz/soplush_new/soplush/profile_pics/${this.props.screenProps.profileData.profile_pic}`}} />
//                         </View> 
//                         :
...
// <LinearGradient start={{ x: 0.0, y: 0.25 }} end={{ x: 0.0, y: 1.0 }} colors={['#800', '#000', '#000']} style={{ width: "100%", borderRadius: 10}}>
        ...
        return (
            <View style={{flex:1, height:'100%', width:'100%', marginTop: -80}}>
                ...
                {/* <View style={{backgroundColor:"#fff",borderRadius:10, width:"90%"}}> */}
                        ...
                        <View style={{backgroundColor:"#800", borderRadius:10, width:"90%",padding:0, marginTop:"10%"}}> 
